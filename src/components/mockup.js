import React from "react";
    ...
    function Mockup({mockupPic, animate, animateType, mockupSofa}) {
      return (
      <div>
        
        <img src={mockupPic} className={`mockup_pic ${animate ? animateType === 'in' ? 'slide-in-blurred-top' : 'slide-out-bck-center' : ''}`} />
